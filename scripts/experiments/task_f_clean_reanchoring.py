#!/usr/bin/env python3
"""
TASK F -- clean closed-loop re-anchoring of the Koopman model
====================================================================================
Direct (non-autoregressive) linear forecasters (DLinear /
NLinear) attain the lowest CLEAN-data error because a single direct map
...
Outputs
  results/experiments/task_f_clean_reanchoring.csv
