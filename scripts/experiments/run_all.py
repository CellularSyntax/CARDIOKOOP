#!/usr/bin/env python3
"""
Top-level runner for ALL experiments in scripts/experiments/ (tasks A-F, tables, figures).
...
retraining of the main model).  Run with the cardiokoop environment:
    ...
    python scripts/experiments/run_all.py            # everything
    python scripts/experiments/run_all.py a b e      # only tasks A, B, E
...
def main(argv):
    ...
    if failures:
        ...
        return 1
    print("All requested experiment steps completed successfully.")
    return 0
