#!/usr/bin/env python3
"""
TASK D -- realistic + streaming noise
========================================================================
Extends the existing AWGN noise harness (task3_noise_robustness.py) with two
more realistic variants, evaluated on the frozen Koopman
...
Outputs
  results/experiments/task_d_realistic_streaming_noise.json
  results/experiments/task_d_realistic_streaming_noise.csv
