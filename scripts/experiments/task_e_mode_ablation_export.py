#!/usr/bin/env python3
"""
TASK E -- main-text-ready mode-ablation export
===========================================================================
...
produced by scripts/experiments/task8_mode_analysis.py on the seed-42 test split).  This
...
Outputs
  results/experiments/table_mode_ablation.csv
  results/experiments/table_mode_ablation.tex
"""
import os
import sys
import json
