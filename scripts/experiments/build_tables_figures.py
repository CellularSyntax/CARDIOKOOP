...
Why a consistent recompute?  The post-processing pickles are internally inconsistent:
...
Koopman headline barely moves (val 17.30 -> test 17.54).  See docs/REPRODUCIBILITY.md.
