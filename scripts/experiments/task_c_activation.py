#!/usr/bin/env python3
"""
TASK C -- control-net output-activation comparison
===============================================================================
...
Both analyses give the same conclusion (see docs/REPRODUCIBILITY.md): a zero-centred
...
Outputs
  results/experiments/task_c_activation.csv / .tex / .json
"""
import os
import sys
import csv
